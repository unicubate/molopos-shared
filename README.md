...
<tr><td>Create Employee Declaration</td><td>"create_employee:coi_declaration"</td></tr>

</table>

## Auth Type <sub><sup>[AuthType](./src/enum/index.ts#L340)</sup></sub>
...
## TAS Onboarding Status <sub><sup>[TAS_OnboardingStatus](./src/enum/index.ts#L347)</sup></sub>
...
## TAS Onboarding Attempt Status <sub><sup>[TAS_OnboardingAttemptStatus](./src/enum/index.ts#L353)</sup></sub>
...
## TAS AML Question Type <sub><sup>[TAS_AMLQuestionType](./src/enum/index.ts#L361)</sup></sub>
...
## TAS AML Answer Type <sub><sup>[TAS_AMLAnswerType](./src/enum/index.ts#L366)</sup></sub>
...
## TAS User Type <sub><sup>[TAS_UserType](./src/enum/index.ts#L371)</sup></sub>
...
## TAS Gender <sub><sup>[TAS_Gender](./src/enum/index.ts#L376)</sup></sub>
...
## TAS Address Type <sub><sup>[TAS_AddressType](./src/enum/index.ts#L381)</sup></sub>
...
## TAS Document Type <sub><sup>[TAS_DocumentType](./src/enum/index.ts#L388)</sup></sub>
...
## TAS Additional Document Type <sub><sup>[TAS_AdditionalDocumentType](./src/enum/index.ts#L400)</sup></sub>
...
## TAS Document Issuer <sub><sup>[TAS_DocumentIssuer](./src/enum/index.ts#L406)</sup></sub>
...
## TAS Shufti Status <sub><sup>[TAS_ShuftiStatus](./src/enum/index.ts#L419)</sup></sub>
...
## TAS Pep <sub><sup>[TAS_Pep](./src/enum/index.ts#L428)</sup></sub>
...
## TAS Pep Type <sub><sup>[TAS_PepType](./src/enum/index.ts#L439)</sup></sub>
...
## TAS Shufti Error Target <sub><sup>[TAS_ShuftiErrorTarget](./src/enum/index.ts#L505)</sup></sub>
...
## TAS Legal Form <sub><sup>[TAS_LegalForm](./src/enum/index.ts#L518)</sup></sub>
...
## TAS Transaction Type <sub><sup>[TAS_TransactionType](./src/enum/index.ts#L594)</sup></sub>
...
## TAS Transaction Status <sub><sup>[TAS_TransactionStatus](./src/enum/index.ts#L600)</sup></sub>
...
## TAS Operation Over All Status <sub><sup>[TAS_OperationOverAllStatus](./src/enum/index.ts#L606)</sup></sub>
...
## TAS Operation Current Status <sub><sup>[TAS_OperationCurrentStatus](./src/enum/index.ts#L625)</sup></sub>
...
## TAS Transaction Direction <sub><sup>[TAS_TransactionDirection](./src/enum/index.ts#L650)</sup></sub>
...
## Tas Contracts Document Type <sub><sup>[TasContracts_DocumentType](./src/enum/index.ts#L655)</sup></sub>
...
## Bank Account Type <sub><sup>[BankAccountType](./src/enum/index.ts#L661)</sup></sub>
...
## Onboarding Types <sub><sup>[OnboardingTypes](./src/enum/index.ts#L666)</sup></sub>
...
## Gateway Type <sub><sup>[GatewayType](./src/enum/index.ts#L671)</sup></sub>
...
## Amortization Method <sub><sup>[AmortizationMethod](./src/enum/index.ts#L676)</sup></sub>
...
## Project Files Type <sub><sup>[ProjectFilesType](./src/enum/index.ts#L681)</sup></sub>
...
## Feature Flag <sub><sup>[FeatureFlag](./src/enum/index.ts#L689)</sup></sub>
...
## User Onboarding Status <sub><sup>[UserOnboardingStatus](./src/enum/index.ts#L704)</sup></sub>
...
## COI Relationship Type <sub><sup>[COI_RelationshipType](./src/enum/index.ts#L708)</sup></sub>
...
## COI Alert Type <sub><sup>[COI_AlertType](./src/enum/index.ts#L745)</sup></sub>
...
## Restitution Type <sub><sup>[RestitutionType](./src/enum/index.ts#L754)</sup></sub>
