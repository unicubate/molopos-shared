...
<tr><td>Read Contract</td><td>"read:contract"</td></tr>
<tr><td>Read Tas Transaction</td><td>"read:tas_transaction"</td></tr>
<tr><td>Read Statistics Transaction</td><td>"read_statistics:transaction"</td></tr>
<tr><td>Read Transaction</td><td>"read:transaction"</td></tr>

</table>

## Auth Type <sub><sup>[AuthType](./src/enum/index.ts#L289)</sup></sub>
...
## TAS Onboarding Status <sub><sup>[TAS_OnboardingStatus](./src/enum/index.ts#L296)</sup></sub>
...
## TAS Onboarding Attempt Status <sub><sup>[TAS_OnboardingAttemptStatus](./src/enum/index.ts#L302)</sup></sub>
...
## TAS AML Question Type <sub><sup>[TAS_AMLQuestionType](./src/enum/index.ts#L309)</sup></sub>
...
## TAS AML Answer Type <sub><sup>[TAS_AMLAnswerType](./src/enum/index.ts#L314)</sup></sub>
...
## TAS User Type <sub><sup>[TAS_UserType](./src/enum/index.ts#L319)</sup></sub>
...
## TAS Gender <sub><sup>[TAS_Gender](./src/enum/index.ts#L324)</sup></sub>
...
## TAS Address Type <sub><sup>[TAS_AddressType](./src/enum/index.ts#L329)</sup></sub>
...
## TAS Document Type <sub><sup>[TAS_DocumentType](./src/enum/index.ts#L336)</sup></sub>
...
## TAS Additional Document Type <sub><sup>[TAS_AdditionalDocumentType](./src/enum/index.ts#L348)</sup></sub>
...
## TAS Document Issuer <sub><sup>[TAS_DocumentIssuer](./src/enum/index.ts#L354)</sup></sub>
...
## TAS Shufti Status <sub><sup>[TAS_ShuftiStatus](./src/enum/index.ts#L367)</sup></sub>
...
## TAS Pep <sub><sup>[TAS_Pep](./src/enum/index.ts#L376)</sup></sub>
...
## TAS Pep Type <sub><sup>[TAS_PepType](./src/enum/index.ts#L387)</sup></sub>
...
## TAS Shufti Error Target <sub><sup>[TAS_ShuftiErrorTarget](./src/enum/index.ts#L453)</sup></sub>
...
## TAS Legal Form <sub><sup>[TAS_LegalForm](./src/enum/index.ts#L466)</sup></sub>
...
## TAS Transaction Type <sub><sup>[TAS_TransactionType](./src/enum/index.ts#L542)</sup></sub>
...
## TAS Transaction Status <sub><sup>[TAS_TransactionStatus](./src/enum/index.ts#L547)</sup></sub>
...
## TAS Operation Over All Status <sub><sup>[TAS_OperationOverAllStatus](./src/enum/index.ts#L552)</sup></sub>
...
## TAS Operation Current Status <sub><sup>[TAS_OperationCurrentStatus](./src/enum/index.ts#L571)</sup></sub>
...
## TAS Transaction Direction <sub><sup>[TAS_TransactionDirection](./src/enum/index.ts#L596)</sup></sub>
...
## Tas Contracts Document Type <sub><sup>[TasContracts_DocumentType](./src/enum/index.ts#L601)</sup></sub>
...
## Bank Account Type <sub><sup>[BankAccountType](./src/enum/index.ts#L607)</sup></sub>
...
## Onboarding Types <sub><sup>[OnboardingTypes](./src/enum/index.ts#L612)</sup></sub>
...
## Gateway Type <sub><sup>[GatewayType](./src/enum/index.ts#L617)</sup></sub>
...
## Amortization Method <sub><sup>[AmortizationMethod](./src/enum/index.ts#L622)</sup></sub>
...
## Project Files Type <sub><sup>[ProjectFilesType](./src/enum/index.ts#L627)</sup></sub>
