...
- [Certifications Status](#certifications-status-certificationsstatus)
- [VOP Match Types](#vop-match-types-vopmatchtypes)
- [Settlement Consent Method](#settlement-consent-method-settlementconsentmethod)
...
<tr><td>Signed Certification</td><td>"SIGNED_CERTIFICATION"</td></tr>
<tr><td>Files</td><td>"FILES"</td></tr>
<tr><td>Contract</td><td>"CONTRACT"</td></tr>

</table>

## Document Status <sub><sup>[DocumentStatus](./src/enum/index.ts#L33)</sup></sub>
...
## Onfido Document Status <sub><sup>[OnfidoDocumentStatus](./src/enum/index.ts#L47)</sup></sub>
...
## Wallet Status <sub><sup>[WalletStatus](./src/enum/index.ts#L54)</sup></sub>
...
## Transaction Status <sub><sup>[TransactionStatus](./src/enum/index.ts#L71)</sup></sub>
...
## Transaction Direction <sub><sup>[TransactionDirection](./src/enum/index.ts#L79)</sup></sub>
...
## Iban Status <sub><sup>[IbanStatus](./src/enum/index.ts#L84)</sup></sub>
...
## Money In Type <sub><sup>[MoneyInType](./src/enum/index.ts#L96)</sup></sub>
...
## Gender Type <sub><sup>[GenderType](./src/enum/index.ts#L105)</sup></sub>
...
## Alert Type <sub><sup>[AlertType](./src/enum/index.ts#L112)</sup></sub>
...
## Notification Type <sub><sup>[NotificationType](./src/enum/index.ts#L118)</sup></sub>
...
## Project Payout Strategy Type <sub><sup>[ProjectPayoutStrategyType](./src/enum/index.ts#L125)</sup></sub>
...
## Event Status <sub><sup>[EventStatus](./src/enum/index.ts#L130)</sup></sub>
...
## Prospect Status <sub><sup>[ProspectStatus](./src/enum/index.ts#L136)</sup></sub>
...
## Prospect Rate Status <sub><sup>[ProspectRateStatus](./src/enum/index.ts#L149)</sup></sub>
...
<tr><td>Overdue</td><td>5</td></tr>

</table>

## Prospect Rate Investor Status <sub><sup>[ProspectRateInvestorStatus](./src/enum/index.ts#L158)</sup></sub>
...
## Investment Status <sub><sup>[InvestmentStatus](./src/enum/index.ts#L167)</sup></sub>
...
## Classification Status <sub><sup>[ClassificationStatus](./src/enum/index.ts#L175)</sup></sub>
...
## Category Project <sub><sup>[CategoryProject](./src/enum/index.ts#L181)</sup></sub>
...
## Project Status <sub><sup>[ProjectStatus](./src/enum/index.ts#L187)</sup></sub>
...
## User Registration Status <sub><sup>[UserRegistrationStatus](./src/enum/index.ts#L203)</sup></sub>
...
## Account Type <sub><sup>[AccountType](./src/enum/index.ts#L213)</sup></sub>
...
## Transaction Type <sub><sup>[TransactionType](./src/enum/index.ts#L219)</sup></sub>
...
## Voucher Category <sub><sup>[VoucherCategory](./src/enum/index.ts#L227)</sup></sub>
...
## Voucher Activity Type <sub><sup>[VoucherActivityType](./src/enum/index.ts#L235)</sup></sub>
...
## Survey Level <sub><sup>[SurveyLevel](./src/enum/index.ts#L241)</sup></sub>
...
## Legal Form <sub><sup>[LegalForm](./src/enum/index.ts#L250)</sup></sub>
...
## Top Investor Type <sub><sup>[TopInvestorType](./src/enum/index.ts#L256)</sup></sub>
...
## Integration Type <sub><sup>[IntegrationType](./src/enum/index.ts#L261)</sup></sub>
...
## Permission <sub><sup>[Permission](./src/enum/index.ts#L269)</sup></sub>
...
<tr><td>Read Project Status</td><td>"read_project_status:project"</td></tr>
<tr><td>Split Prospect Rate</td><td>"split:prospect_rate"</td></tr>
...
<tr><td>Read Email Templates (postmark marketing mails)</td><td>"read:email_templates"</td></tr>
<tr><td>Send Batch Emails</td><td>"send_batch:emails"</td></tr>
<tr><td>Read Features Flag (features flag)</td><td>"read:features_flag"</td></tr>
<tr><td>Create Features Flag</td><td>"create:features_flag"</td></tr>
<tr><td>Update Features Flag</td><td>"update:features_flag"</td></tr>
<tr><td>Delete Features Flag</td><td>"delete:features_flag"</td></tr>

</table>

## Auth Type <sub><sup>[AuthType](./src/enum/index.ts#L379)</sup></sub>
...
## TAS Onboarding Status <sub><sup>[TAS_OnboardingStatus](./src/enum/index.ts#L386)</sup></sub>
...
## TAS Onboarding Attempt Status <sub><sup>[TAS_OnboardingAttemptStatus](./src/enum/index.ts#L392)</sup></sub>
...
## TAS AML Question Type <sub><sup>[TAS_AMLQuestionType](./src/enum/index.ts#L400)</sup></sub>
...
## TAS AML Answer Type <sub><sup>[TAS_AMLAnswerType](./src/enum/index.ts#L405)</sup></sub>
...
## TAS User Type <sub><sup>[TAS_UserType](./src/enum/index.ts#L410)</sup></sub>
...
## TAS Gender <sub><sup>[TAS_Gender](./src/enum/index.ts#L415)</sup></sub>
...
## TAS Address Type <sub><sup>[TAS_AddressType](./src/enum/index.ts#L420)</sup></sub>
...
## TAS Document Type <sub><sup>[TAS_DocumentType](./src/enum/index.ts#L427)</sup></sub>
...
## TAS Additional Document Type <sub><sup>[TAS_AdditionalDocumentType](./src/enum/index.ts#L439)</sup></sub>
...
## TAS Document Issuer <sub><sup>[TAS_DocumentIssuer](./src/enum/index.ts#L445)</sup></sub>
...
## TAS Shufti Status <sub><sup>[TAS_ShuftiStatus](./src/enum/index.ts#L458)</sup></sub>
...
## TAS Pep <sub><sup>[TAS_Pep](./src/enum/index.ts#L467)</sup></sub>
...
## TAS Pep Type <sub><sup>[TAS_PepType](./src/enum/index.ts#L478)</sup></sub>
...
## TAS Shufti Error Target <sub><sup>[TAS_ShuftiErrorTarget](./src/enum/index.ts#L544)</sup></sub>
...
## TAS Legal Form <sub><sup>[TAS_LegalForm](./src/enum/index.ts#L557)</sup></sub>
...
## TAS Transaction Type <sub><sup>[TAS_TransactionType](./src/enum/index.ts#L633)</sup></sub>
...
## TAS Transaction Status <sub><sup>[TAS_TransactionStatus](./src/enum/index.ts#L639)</sup></sub>
...
## TAS Operation Over All Status <sub><sup>[TAS_OperationOverAllStatus](./src/enum/index.ts#L645)</sup></sub>
...
## TAS Operation Current Status <sub><sup>[TAS_OperationCurrentStatus](./src/enum/index.ts#L664)</sup></sub>
...
## TAS Transaction Direction <sub><sup>[TAS_TransactionDirection](./src/enum/index.ts#L691)</sup></sub>
...
## Tas Contracts Document Type <sub><sup>[TasContracts_DocumentType](./src/enum/index.ts#L696)</sup></sub>

<table>
<tr><td>Contract</td><td>"Contratto"</td></tr>
<tr><td>Bank Statement</td><td>"EstrattoConto"</td></tr>
<tr><td>Ownership</td><td>"ownership"</td></tr>
<tr><td>Periodic Report</td><td>"RelazionePeriodica"</td></tr>

</table>

## Bank Account Type <sub><sup>[BankAccountType](./src/enum/index.ts#L703)</sup></sub>
...
## Onboarding Types <sub><sup>[OnboardingTypes](./src/enum/index.ts#L708)</sup></sub>
...
## Gateway Type <sub><sup>[GatewayType](./src/enum/index.ts#L713)</sup></sub>
...
## Amortization Method <sub><sup>[AmortizationMethod](./src/enum/index.ts#L718)</sup></sub>
...
## Project Files Type <sub><sup>[ProjectFilesType](./src/enum/index.ts#L723)</sup></sub>
...
## Feature Flag <sub><sup>[FeatureFlag](./src/enum/index.ts#L731)</sup></sub>
...
## User Onboarding Status <sub><sup>[UserOnboardingStatus](./src/enum/index.ts#L746)</sup></sub>
...
## COI Relationship Type <sub><sup>[COI_RelationshipType](./src/enum/index.ts#L750)</sup></sub>
...
## COI Alert Type <sub><sup>[COI_AlertType](./src/enum/index.ts#L792)</sup></sub>
...
## Restitution Type <sub><sup>[RestitutionType](./src/enum/index.ts#L802)</sup></sub>
...
## Project File Type <sub><sup>[ProjectFileType](./src/enum/index.ts#L807)</sup></sub>
...
## Project File Subtype <sub><sup>[ProjectFileSubtype](./src/enum/index.ts#L813)</sup></sub>
...
## Event Type <sub><sup>[EventType](./src/enum/index.ts#L818)</sup></sub>
...
## Partial Rate Types <sub><sup>[PartialRateTypes](./src/enum/index.ts#L823)</sup></sub>
...
## Certifications Status <sub><sup>[CertificationsStatus](./src/enum/index.ts#L829)</sup></sub>

<table>
<tr><td>Draft</td><td>"DRAFT"</td></tr>
<tr><td>Generated</td><td>"GENERATED"</td></tr>
<tr><td>Confirmed</td><td>"CONFIRMED"</td></tr>
<tr><td>Signed By Proponent</td><td>"SIGNED_BY_PROPONENT"</td></tr>
<tr><td>Sent To Investor</td><td>"SENT_TO_INVESTOR"</td></tr>

</table>

## VOP Match Types <sub><sup>[VOPMatchTypes](./src/enum/index.ts#L837)</sup></sub>

<table>
<tr><td>Match</td><td>"MTCH"</td></tr>
<tr><td>Partial Match</td><td>"CMTC"</td></tr>
<tr><td>No Match</td><td>"NMTC"</td></tr>
<tr><td>Not Applicable</td><td>"NOAP"</td></tr>
<tr><td>Error</td><td>"ERRR"</td></tr>

</table>

## Settlement Consent Method <sub><sup>[SettlementConsentMethod](./src/enum/index.ts#L845)</sup></sub>

<table>
<tr><td>Manual</td><td>"MANUAL"</td></tr>
<tr><td>Digital Signature</td><td>"DIGITAL_SIGNATURE"</td></tr>
